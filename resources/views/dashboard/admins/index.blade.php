                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-250px">البريد الالكتروني</th>
                            <th class="min-w-250px">رقم المستخدم</th>
                            ...
                            <tr data-id="{{$user->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('admins.edit', $user->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$user->name}}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('admins.edit', $user->id)}}" class="menu-link px-3">تعديل</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                        @can('admins.destroy')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="{{route('admins.destroy', $user->id)}}" data-id="{{$user->id}}">حذف</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                    </div>
