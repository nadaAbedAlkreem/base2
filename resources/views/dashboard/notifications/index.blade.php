        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    ...
                    <button type="button"  onclick="initFirebaseMessagingRegistration()" data-route="{{route('notifications.storeToken')}}" 
                    class="btn btn-info">
                        <i class="bi bi-bell fs-3"></i>@lang('dashboard.allow_notifications')</button>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="#" class="symbol symbol-50px">
                                            <span class="symbol-label" style="background-image:url({{$notification->sender['image']}});"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('notifications.edit', $notification->id) }}" 
                                                class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$notification->title}}</a>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('notifications.edit', $notification->id)}}" class="menu-link px-3">@lang('dashboard.edit')</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
