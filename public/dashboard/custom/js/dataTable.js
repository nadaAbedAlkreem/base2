        ...
        n = () => {
            t.querySelectorAll(
                ...
                t.addEventListener("click", function (t) {
                    ...
                    Swal.fire({
                        text:
                            `${$.localize.data["app"]["common"]["check_for_delete"]}` +
                            o +
                            "?",
                        icon: "warning",
                        showCancelButton: !0,
                                  ...
                                  success: (response) => {
                                      ...
                                      if (response.message) {
                                          Swal.fire({
                                              ...
                                              icon: "error", // أو يمكنك استخدام "warning" بدلاً من "error"
                                              buttonsStyling: !1,
                                          ...
                                          Swal.fire({
                                              text:
                                                  `${$.localize.data["app"]["common"]["deleted"]}` +
                                                  o +
                                                  "!.",
                                              icon: "success",
                                              buttonsStyling: !1,
