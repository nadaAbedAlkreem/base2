...
trait SmsTrait {
  ...
  public function sendSms($phone, $msg) {
    ...
    case 'zain':
      ...
      break;
    case 'qyadat':
      $this->qyadat($phone, $msg);
      break;
    }

  }

  public function qyadat($phone, $msg) {
    $data     = SMS::where(['key' => 'qyadat'])->first();
    $username = $data->user_name;
    $password = $data->password;
    $text     = urlencode($msg);
    $sender   = urlencode($data->sender_name);
    $url ="http://www.qyadat.com/sms/api/sendsms.php?username=$username&password=$password&message=$text&numbers=$phone&sender=$sender&unicode=e&return=string";
